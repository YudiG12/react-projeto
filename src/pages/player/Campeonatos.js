...
class CampeonatosParticipo extends Component {
    constructor(props){
        super(props)
    ...
    getAllChampionships = () => {
        championships.allChampionshipsParticipe()
        .then(championship => {
...
CampeonatosParticipo.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(CampeonatosParticipo);
