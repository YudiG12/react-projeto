...
class Campeonato extends Component {
    ...
    constructor(props) {
        ...
        this.state.championship = pathnameVet[2]
        this.getAllTeams(pathnameVet[2])
        this.getAllInvites(pathnameVet[2])
        this.getAllMatchs(pathnameVet[2])
    }
    ...
    criarPartida = () => {
        window.location.href = '/campeonato/criar/partida/' + this.state.championship;
    }

    criarConvite = () => {
        window.location.href = '/campeonato/criar/convite/' + this.state.championship;
    }
